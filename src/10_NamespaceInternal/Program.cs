    ...
    namespace InternalNamespace
    {
        ...
        class Fabric : NamespaceFabric
        {
         ...
         "'{0}' can be used only in the namespace '{1}'." );
            ...
            {
                amender.WithTargetMembers( c => c.AllTypes.Where( t => t.Accessibility == Accessibility.Internal ) ).RegisterReferenceValidator( this.ValidateReference, ReferenceKinds.All );
            }
